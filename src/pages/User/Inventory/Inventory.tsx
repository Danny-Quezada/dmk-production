...
const Inventory = () => {
  ...
  const [showOutlet, setOutlet] = useState("");
  const [showMenu, useMenu] = useState<boolean>(false);
          ...
          >
            ...
            >
              ...
              <div>
                ...
                >
                  <VscKebabVertical size={30} color="black" />
                </button>
              </div>
            </div>
